/**
 * Este archivo contiene los metodos y procedimientos necesarios para la ejecucion y gestion
 * de un pequeño servidor de pagina web para la configuracion del dispositivo.
 */
